...
class Income extends Component {
    ...
    componentDidMount() {
        const {customizedV3: {spouseIncome}} = this.props;
        this.setState({income:[spouseIncome]})
        const { amount, channel } = this.props;
        Utils.collectBaiduHm(`1v1_v3.0_${amount}_${channel}_表单7-收入-配偶`, "open")
    }
