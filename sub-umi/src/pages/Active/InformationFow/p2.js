...
class index extends Component {
    ...
    initCollectBd = () => {
        ...
        const category = `flow_${terminal}_2_${utm_source}`;
        ...
        return (
            <div className={styles.flowStyle2}>
                <div className={styles.details} onClick={(e) => { e.preventDefault() }}>
                    <h3>
                        <span>【爆】</span>想买保险挑花眼，怕被坑，怎么办？在线咨询第三方测评专家，最终少花10万冤枉钱！！
                    </h3>
                    <img src={require('./images/p2/1.png')} onClick={() => this.openPop()} />
                    <div className={styles.btnContainer}>
                        <button className={styles.topReceive} onClick={() => this.openPop()}><img src={require('./images/p2/banner.gif')} /></button>
                        <img src={require('./images/p2/2.png')} />
                    </div>
                    <img src={require('./images/p2/3.png')} />
                    <img src={require('./images/p2/4.png')} />
                    <img src={require('./images/p2/5.png')} />
                    <img src={require('./images/p2/6.png')} />
                    <img src={require('./images/p2/7.png')} />
                    <img src={require('./images/p2/8.png')} />
                    <footer>
                ...
                <footer className={styles.footer} onClick={() => this.openPop()}>
                    <img src={require('./images/p2/footer.gif')} />
                </footer>
            </div>
        );
    }
