...
第四条赔偿处理
（1）被保险人索赔时，应提供运单、起运地货物价格证明等相关单据。保险人在责任限额内按起运地价格计算赔偿；
...
export default <div className={styles.con}>
  <div className={styles.title}>中国保险行业协会机动车商业保险示范条款（2020版）</div>
  <div className={styles.content} dangerouslySetInnerHTML={{ __html: text }}/>
  <div className={styles.linkCon}>
    <span>参见：</span>
    <a href='http://www.iachina.cn/art/2020/9/4/art_24_104621.html'>关于发布《中国保险行业协会机动车商业保险示范条款（2020版）》等五个商业车险示范条款的通知</a>
    <a href='https://www.iachina.cn/art/2021/12/14/art_24_105694.html'>关于发布《中国保险行业协会新能源汽车商业保险专属条款（试行）》的通知</a>
  </div>
</div>